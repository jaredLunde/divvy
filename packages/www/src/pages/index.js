...
const Loading = <Hero align='center' justify='center' children={<DelayedSpinner size={32} color='white'/>}/>
...
export const Onboarding = route({
  path: urls.start(),
  exact: true,
  component: lazy('./Onboarding', lazyProps)
})
export const Dashboard = route({
  path: urls.dashboard(':id/:pageType?'),
  exact: true,
  component: lazy('./Dashboard', lazyProps)
})
